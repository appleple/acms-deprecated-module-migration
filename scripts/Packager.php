...
final class Packager
{
    ...
    /**
     * Derive the plugin folder name (e.g. "DeprecatedModuleMigration") from the composer.json in the project root.
     */
     ...
     * e.g. "{pluginName}v{version}" → "DeprecatedModuleMigrationv1.2.3". Keeping the version in the name helps when
